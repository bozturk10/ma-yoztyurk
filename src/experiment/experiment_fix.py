...
from src.data.process_data import process_open_ended, process_wave_data, process_wave_data_old
...
def main():
    ...
    wave_df_processed_old = process_wave_data_old(wave_df, wave_open_ended_df, wave_number)
    ...
    wave_df_processed = wave_df_processed[ wave_df_processed_old.code_2320!=wave_df_processed.code_2320]
    logger.warning(f"Remaining broken {len(wave_df_processed)} samples are being replaced.")
